                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="p_terakhir" class="form-control" id="inputEmail3"
                                placeholder="Inputkan Pendidikan Terakhir" required>
                              </div>
                            </div>
...
if($_POST){
    ...
    //buat sql
    $sql="INSERT INTO tb_karyawan VALUES ('','$nama','$alamat','$tgllahir','$agama','$jkelamin','$pterakhir')";
