    ...
    <body onload="print()">
        ...
        <div class="container">
            <div class='row'>
                ...
                <thead>
                                <tr>
                                    <th>No.</th><th>Nama</th><th>Alamat</th><th>Tgl Lahir </th><th>Agama</th><th>Jenis Kelamin</th><th>Pendidikan Terakhir</th>
                                </tr>
                                </thead>
                            <tbody>
                            ...
                            $sql = "SELECT * FROM tb_karyawan WHERE substr(tgl_pinjam,1,7)='$ambilthn-$ambilbln'";
